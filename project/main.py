...
@app.route('/')
def home():
    return render_template('index.html')  # Теперь рендерим index.html
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and user.check_password(form.password.data):
            ...
            return redirect(url_for('home'))  # Было 'dashboard', стало 'home'
        else:
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if existing_user:
            ...
            # Редирект на главную (index.html) вместо login.html
            flash('Регистрация успешна! Добро пожаловать.', 'success')
            return redirect(url_for('home'))  # Изменено с 'login' на 'home'
